...
export const resetPasswordUrl = `${apiUrl}/reset-password`;
export const verifyOtpAndResetPasswordUrl = `${apiUrl}/verify-otp-and-reset-password`;
...
export const changeClientPasswordUrl = `${apiUrl}/change-client-password`;
//Therapist
...
export const ToggleMyVisibilityUrl = `${apiUrl}/toggle-my-visibility`;
export const createBlogUrl = `${apiUrl}/create-blog`;
export const getBlogsUrl = `${apiUrl}/get-blogs`;
export const getBlogUrl = `${apiUrl}/get-blog-by-id`;
...
export const GetCouponsUrl = `${apiUrl}/coupon/get`;
export const CreateCouponsUrl = `${apiUrl}/coupon/create`;
...
export const chatDeleteConversationUrl = `${apiUrl}/chat/therapist/conversation`;
